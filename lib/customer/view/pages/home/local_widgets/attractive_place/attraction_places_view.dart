  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: PageView.builder(
        ...
        itemCount: AttractivePlacesList.list.length,
        ...
        Expanded(
          child: TweenAnimationBuilder(
            ...
            child: Container(
              ...
              child: Hero(
                tag: AttractivePlacesList.list[index].name,
                child: Image.asset(
                  AttractivePlacesList.list[index].image,
                  fit: BoxFit.cover,
                ).onTap(function: () {
                  Navigator.push(
                    context,
                    PageRouteBuilder(
                      ...
                      settings:
                          RouteSettings(arguments: AttractivePlacesList.list[index]),
                    ),
                  );
                }),
              ),
